...
test('It should save information in sessionStorage', () => {
  ...
  const item = sessionStorage.getItem('senscritique_5c68903a7be732b58d17c41f5c4c24ff')
...
test('It should fetch information in sessionStorage', () => {
  const cache = new Cache()
  sessionStorage.setItem('senscritique_5c68903a7be732b58d17c41f5c4c24ff', '{"rating":"10","name":"Breaking bad","hashId":"5c68903a7be732b58d17c41f5c4c24ff"}')
